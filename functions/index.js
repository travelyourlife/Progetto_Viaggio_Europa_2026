...
const CURIOSITA = [
  ...
  { day: 6, emoji: '🏰', text: 'Il centro storico di Tallinn è uno dei meglio conservati d\'Europa medievale — le mura del XIII secolo circondano ancora la città vecchia con 26 torri di guardia superstiti.' },
  { day: 6, emoji: '💊', text: 'La farmacia del Municipio di Tallinn (Raeapteek) è una delle più antiche d\'Europa ancora in attività — aperta dal 1422, vendeva rimedi come succo di lumaca e polvere di unicorno.' },
  { day: 6, emoji: '🎵', text: 'Ogni 5 anni Tallinn ospita il Festival del Canto (Laulupidu) con 30.000 cantori sul palco — fu attraverso il canto che l\'Estonia riconquistò l\'indipendenza nel 1991 (Rivoluzione Cantata).' },
  { day: 7, emoji: '🧖', text: 'In Finlandia ci sono 3,3 milioni di saune per 5,5 milioni di abitanti — più saune che automobili!' },
  { day: 7, emoji: '🏝️', text: 'La Finlandia ha 187.888 laghi (con superficie > 500 m²) — è davvero il "Paese dei mille laghi", anzi dei quasi duecentomila!' },
  { day: 7, emoji: '☕', text: 'I finlandesi sono i maggiori consumatori di caffè al mondo: 12 kg pro capite all\'anno — il doppio degli italiani!' },
  { day: 8, emoji: '🌲', text: 'La cresta di Punkaharju è una formazione glaciale lunga 7 km tra due laghi — lo Zar Alessandro I la dichiarò paesaggio protetto nel 1803.' },
  { day: 8, emoji: '🎨', text: 'Punkaharju ospita il Retretti Art Centre, un museo d\'arte costruito dentro grotte naturali — l\'acustica è così perfetta che ci fanno concerti.' },
  { day: 8, emoji: '🌅', text: 'Il lago Saimaa è il quarto lago più grande d\'Europa (4.380 km²) e ha oltre 13.000 isole — più isole che in molti arcipelaghi marini!' },
  { day: 9, emoji: '🦭', text: 'Nel lago Saimaa vive la foca degli anelli più rara del mondo: ne restano solo ~480 esemplari, intrappolati qui dalla fine dell\'era glaciale.' },
  { day: 9, emoji: '🛶', text: 'Il sistema lacustre di Saimaa ha oltre 14.000 km di costa — più della costa marittima di molti paesi europei!' },
  { day: 9, emoji: '🌌', text: 'D\'estate in Finlandia il cielo non diventa mai completamente buio — il fenomeno delle "notti bianche" dura da maggio ad agosto.' },
  { day: 10, emoji: '🎸', text: 'Oulu ospita ogni anno i Campionati Mondiali di Air Guitar — sì, è una competizione seria dal 1996!' },
  { day: 10, emoji: '🚴', text: 'Oulu è la città ciclabile più a nord del mondo: ha 600 km di piste ciclabili usate anche a -30°C con pneumatici chiodati!' },
  { day: 10, emoji: '📡', text: 'Oulu è la "Silicon Valley del Nord": Nokia vi ha il più grande centro di ricerca, e la città ha più ingegneri pro capite di qualsiasi città finlandese.' },
  { day: 11, emoji: '🐻‍❄️', text: 'Lo zoo artico di Ranua è l\'unico zoo al mondo dove si possono vedere gli orsi polari a queste latitudini in un habitat quasi naturale.' },
  { day: 11, emoji: '🦉', text: 'A Ranua vivono oltre 50 specie artiche tra cui il gufo delle nevi, la volpe artica e il ghiottone — animali quasi impossibili da vedere in natura.' },
  { day: 11, emoji: '❄️', text: 'D\'inverno a Ranua la temperatura può scendere a -45°C — ma d\'estate (quando sarete voi) può superare i 25°C. Un\'escursione termica di 70 gradi!' },
  { day: 12, emoji: '🎅', text: 'Rovaniemi riceve ogni anno oltre 500.000 lettere indirizzate a Babbo Natale da bambini di 198 paesi diversi.' },
  { day: 12, emoji: '🏗️', text: 'Rovaniemi fu completamente distrutta dai tedeschi nel 1944 e ricostruita su progetto di Alvar Aalto — la pianta della città vista dall\'alto ha la forma di una renna!' },
  { day: 12, emoji: '🌡️', text: 'Rovaniemi detiene il record finlandese di escursione termica annuale: da -45°C in inverno a +33°C in estate — 78 gradi di differenza!' },
  { day: 13, emoji: '📐', text: 'Il Circolo Polare Artico (66°33\'N) passa esattamente attraverso il Santa Claus Village — c\'è una linea dipinta sul pavimento dove puoi attraversarlo!' },
  { day: 13, emoji: '🏛️', text: 'L\'Arktikum di Rovaniemi è un museo scientifico con un tunnel di vetro lungo 172 metri che punta verso il Polo Nord — di notte si illumina come un\'aurora.' },
  { day: 13, emoji: '📮', text: 'L\'ufficio postale di Babbo Natale ha un timbro speciale con il Circolo Polare Artico — ogni cartolina spedita da qui arriva con quel timbro unico.' },
  { day: 14, emoji: '🦌', text: 'Il popolo Sami è l\'unico popolo indigeno riconosciuto dell\'UE. La loro lingua ha oltre 300 parole diverse per descrivere la neve e il ghiaccio.' },
  { day: 14, emoji: '🌊', text: 'Il lago Inari è il terzo lago più grande della Finlandia (1.040 km²) e ha oltre 3.000 isole — molte considerate sacre dai Sami.' },
  { day: 14, emoji: '🏔️', text: 'Il museo Siida a Inari documenta 10.000 anni di cultura Sami — il popolo che ha abitato queste terre dall\'ultima era glaciale.' },
  { day: 15, emoji: '🪨', text: 'A Kilpisjärvi c\'è il Treriksröset: il punto dove si incontrano i confini di Finlandia, Svezia e Norvegia. Puoi stare in 3 paesi contemporaneamente!' },
  { day: 15, emoji: '🌿', text: 'Kilpisjärvi è il punto più a nord-ovest della Finlandia — qui la tundra artica inizia e gli alberi smettono di crescere (treeline).' },
  { day: 15, emoji: '🦅', text: 'Nella zona di Kilpisjärvi nidifica l\'aquila reale artica — una delle popolazioni più settentrionali del mondo.' },
  { day: 16, emoji: '⛪', text: 'La Cattedrale Artica di Tromsø (Ishavskatedralen) ha una vetrata di 140 m² — una delle più grandi d\'Europa, visibile anche di notte col sole di mezzanotte.' },
  { day: 16, emoji: '🍺', text: 'Tromsø ha lo storico birrificio Mack (fondato nel 1877), uno dei più settentrionali del mondo, e la più alta concentrazione di pub pro capite della Norvegia.' },
  { day: 16, emoji: '🌅', text: 'A Tromsø il sole di mezzanotte dura dal 20 maggio al 22 luglio — quando sarete lì, il sole NON tramonterà mai. Nemmeno a mezzanotte!' },
  { day: 17, emoji: '👹', text: 'Senja ospita il Troll più grande del mondo: Senjatrollet, alto 18 metri, con una grotta-museo dentro la pancia!' },
  { day: 17, emoji: '🏝️', text: 'Senja è la seconda isola più grande della Norvegia (1.586 km²) — i norvegesi la chiamano "la Norvegia in miniatura" perché ha fiordi, montagne e spiagge.' },
  { day: 17, emoji: '🦅', text: 'Le aquile di mare (Havørn) di Senja hanno un\'apertura alare di 2,5 metri — sono le più grandi aquile d\'Europa e si vedono facilmente dalla strada.' },
  { day: 18, emoji: '🚀', text: 'Ad Andøya c\'è una base spaziale attiva — la Andøya Space, da cui vengono lanciati razzi di ricerca scientifica nell\'atmosfera dal 1962.' },
  { day: 18, emoji: '🐟', text: 'Andenes era il centro della caccia alle balene in Norvegia — oggi le balene si osservano solo per turismo, con un tasso di avvistamento del 95%.' },
  { day: 18, emoji: '🌊', text: 'La fossa oceanica al largo di Andenes scende a 2.500 metri a soli 7 km dalla costa — ecco perché i capodogli vengono così vicini!' },
  { day: 19, emoji: '🐋', text: 'I capodogli di Andenes si immergono fino a 2.000 metri di profondità per cacciare calamari giganti — trattengono il respiro per 90 minuti!' },
  { day: 19, emoji: '🧠', text: 'Il cervello del capodoglio pesa 7,8 kg — il più grande di qualsiasi animale mai esistito sulla Terra, 5 volte quello umano.' },
  { day: 19, emoji: '📡', text: 'I capodogli comunicano con "click" che viaggiano per chilometri sott\'acqua — ogni individuo ha un pattern unico, come un\'impronta digitale sonora.' },
  { day: 20, emoji: '🐟', text: 'Le Lofoten producono il 70% di tutto lo stoccafisso norvegese — il merluzzo viene essiccato all\'aria aperta sui caratteristici hjell da oltre 1.000 anni.' },
  { day: 20, emoji: '🌡️', text: 'Le Lofoten hanno la più grande anomalia termica positiva del mondo per la loro latitudine: sono a 68°N ma d\'inverno non scendono mai sotto -5°C grazie alla Corrente del Golfo.' },
  { day: 20, emoji: '🎨', text: 'Svolvær è la "capitale artistica" delle Lofoten — ha più gallerie d\'arte pro capite di qualsiasi città norvegese.' },
  { day: 21, emoji: '⚽', text: 'Henningsvær ha il campo da calcio più scenografico del mondo: costruito su un isolotto tra le montagne, circondato dal mare su tutti i lati.' },
  { day: 21, emoji: '🎣', text: 'Henningsvær era il più grande villaggio di pescatori delle Lofoten — durante la stagione del merluzzo (gen-apr) la popolazione triplicava.' },
  { day: 21, emoji: '🌅', text: 'Le Lofoten sono state votate come la terza isola più bella del mondo da National Geographic — davanti a Bali e alle Maldive!' },
  { day: 22, emoji: '🏖️', text: 'Haukland Beach alle Lofoten è stata votata tra le 10 spiagge più belle del mondo — con sabbia bianca e acqua turchese... a 68° Nord!' },
  { day: 22, emoji: '🏄', text: 'Unstad Beach alle Lofoten è il surf spot più a nord del mondo — i surfisti cavalcano onde artiche con temperature dell\'acqua di 6°C!' },
  { day: 22, emoji: '🌊', text: 'Le spiagge delle Lofoten hanno sabbia bianca formata da coralli e conchiglie triturate — non da quarzo come la maggior parte delle spiagge.' },
  { day: 23, emoji: '📸', text: 'Reine è stata eletta "villaggio più bello della Norvegia" dalla rivista Allers nel 1970 — da allora è diventata l\'immagine iconica delle Lofoten.' },
  { day: 23, emoji: '🏔️', text: 'Il Reinebringen (448m) offre la vista più fotografata della Norvegia — la salita dura 1h ma la vista su Reine vale ogni passo.' },
  { day: 23, emoji: '🎬', text: 'Le Lofoten sono state location per film e serie TV internazionali grazie alla luce unica — il sole basso crea un\'"ora d\'oro" che dura ore.' },
  { day: 24, emoji: '🏚️', text: 'Nusfjord è uno dei villaggi di pescatori meglio conservati della Norvegia — le sue rorbu (capanne rosse) risalgono al 1800 e sono Patrimonio UNESCO.' },
  { day: 24, emoji: '🔴', text: 'Le rorbu rosse delle Lofoten devono il colore al "rødfarge" — una vernice a base di olio di fegato di merluzzo e ossido di ferro, usata da 500 anni.' },
  { day: 24, emoji: '🐙', text: 'Le acque delle Lofoten ospitano il più grande calamaro mai pescato in Norvegia: 12 metri di lunghezza, trovato nel 2017.' },
  { day: 25, emoji: '🌀', text: 'Il Saltstraumen vicino a Mo i Rana è la corrente di marea più forte del mondo: 400 milioni di m³ d\'acqua passano in un canale stretto a 37 km/h!' },
  { day: 25, emoji: '🦀', text: 'Il Saltstraumen attira enormi quantità di pesce — i pescatori locali catturano merluzzi di 20+ kg grazie ai nutrienti portati dalla corrente.' },
  { day: 25, emoji: '🧊', text: 'Il ghiacciaio Svartisen vicino a Mo i Rana è il secondo più grande della Norvegia (370 km²) — e uno dei pochi al mondo raggiungibile in barca.' },
  ...
  { day: 26, emoji: '🌊', text: 'L\'Atlanterhavsveien (Strada dell\'Atlantico) è lunga solo 8,3 km ma ha 8 ponti che saltano da un isolotto all\'altro — votata "strada del secolo" in Norvegia.' },
  { day: 26, emoji: '🎬', text: 'L\'Atlanterhavsveien è stata usata in pubblicità automobilistiche e film — durante le tempeste le onde scavalcano la strada creando scene spettacolari.' },
  { day: 26, emoji: '🌹', text: 'Molde è chiamata "la città delle rose" — ha un roseto con 2.000 piante e una vista panoramica su 222 cime innevate dall\'altra parte del fiordo.' },
  { day: 27, emoji: '🐉', text: 'La Trollstigen (Scala dei Troll) ha 11 tornanti con pendenza del 10% e una cascata che attraversa la strada — aperta solo da maggio a ottobre.' },
  { day: 27, emoji: '🌊', text: 'La cascata Stigfossen sulla Trollstigen cade per 240 metri — l\'acqua nebulizzata bagna le auto che passano sotto. Chiudete i finestrini!' },
  { day: 27, emoji: '👹', text: 'Secondo la leggenda norvegese, i troll si pietrificano alla luce del sole — le montagne frastagliate della Trollstigen sarebbero troll trasformati in roccia.' },
  { day: 28, emoji: '💎', text: 'Il Geirangerfjord è Patrimonio UNESCO dal 2005 — le cascate "Sette Sorelle" cadono per 250 metri direttamente nel fiordo.' },
  { day: 28, emoji: '🚢', text: 'Il Geirangerfjord è lungo 15 km e profondo 260 m — le navi da crociera che ci entrano sembrano giocattoli tra le pareti rocciose alte 1.400 m.' },
  { day: 28, emoji: '🏚️', text: 'Sulle pareti del Geirangerfjord ci sono fattorie abbandonate raggiungibili solo in barca o con scale a pioli — ci vivevano famiglie fino agli anni \'60.' },
  { day: 29, emoji: '🏔️', text: 'Il Nærøyfjord è il fiordo più stretto della Norvegia — in alcuni punti è largo appena 250 metri con pareti verticali di 1.700 m. È Patrimonio UNESCO dal 2005.' },
  { day: 29, emoji: '👁️', text: 'La piattaforma panoramica Stegastein sporge 30 metri nel vuoto sopra l\'Aurlandsfjord a 650 m di altezza — il pavimento in vetro permette di guardare direttamente nel fiordo sotto i piedi.' },
  { day: 29, emoji: '🚂', text: 'Flåm ha una delle ferrovie più ripide del mondo senza cremagliera: la Flåmsbana sale 866 m in soli 20 km con pendenze fino al 5,5%. Ogni anno trasporta quasi un milione di passeggeri.' },
  { day: 30, emoji: '🌊', text: 'Eidfjord è un villaggio di soli 900 abitanti circondato da cascate e montagne — il Hardangerfjord su cui si affaccia è il secondo fiordo più lungo della Norvegia (179 km).' },
  { day: 30, emoji: '🍎', text: 'L\'Hardangerfjord è il \'frutteto della Norvegia\': il microclima mite permette la coltivazione di mele, ciliegie e pere — a maggio la fioritura dei frutteti è uno spettacolo imperdibile.' },
  { day: 30, emoji: '🏛️', text: 'Il Hardangervidda Nature Centre a Eidfjord ha un cinema panoramico a 5 schermi che proietta filmati dell\'altopiano in tutte le stagioni — il modo migliore per vedere renne e volpi artiche senza scalare montagne.' },
  { day: 31, emoji: '💧', text: 'Vøringsfossen (182 m) era la cascata più visitata della Norvegia già nell\'800 — il Kaiser Guglielmo II la visitò 3 volte. Oggi un ponte panoramico sospeso nel vuoto offre una vista vertiginosa.' },
  { day: 31, emoji: '🍒', text: 'L\'Hardangerfjord è il "frutteto della Norvegia" — produce il 40% delle mele e il 100% delle ciliegie del paese. A fine luglio i ciliegi sono carichi di frutti.' },
  { day: 31, emoji: '🏔️', text: 'Il Trolltunga ("lingua del troll") sporge 700 m sopra il lago Ringedalsvatnet vicino a Eidfjord — è una delle formazioni rocciose più spettacolari della Norvegia, ma richiede 10-12h di trekking.' },
  { day: 32, emoji: '🌧️', text: 'Bergen è la città più piovosa d\'Europa: piove in media 231 giorni all\'anno (2.250 mm). I locali dicono: "Non esiste cattivo tempo, solo cattivo abbigliamento".' },
  { day: 32, emoji: '🏘️', text: 'Bryggen, il quartiere anseatico di Bergen, ha case in legno del XIV secolo — è Patrimonio UNESCO e il quartiere in legno più antico del Nord Europa.' },
  { day: 32, emoji: '🐟', text: 'Il mercato del pesce di Bergen (Fisketorget) è attivo dal 1276 — quasi 750 anni di commercio ininterrotto nello stesso posto!' },
  { day: 33, emoji: '🛢️', text: 'Stavanger è la "capitale del petrolio" della Norvegia — il Norwegian Petroleum Museum racconta come il petrolio del Mare del Nord ha reso la Norvegia il paese più ricco d\'Europa.' },
  { day: 33, emoji: '🗡️', text: 'A Stavanger ci sono tre spade giganti di 10 metri conficcate nella roccia (Sverd i fjell) — commemorano la battaglia che unificò la Norvegia nell\'872.' },
  { day: 33, emoji: '🧗', text: 'Il Preikestolen (Pulpito) è una piattaforma rocciosa piatta di 25×25 metri sospesa a 604 metri sopra il Lysefjord — senza ringhiere!' },
  { day: 33, emoji: '⛰️', text: 'Il Kjeragbolten è un masso di 5 m³ incastrato tra due pareti rocciose a 984 metri d\'altezza — la foto in piedi sopra è un classico (vertiginoso!) norvegese.' },
  { day: 34, emoji: '🏮', text: 'Il faro di Lindesnes è il punto più a sud della Norvegia continentale (57°58\'N) — da qui alla punta nord (Capo Nord) ci sono esattamente 2.518 km di costa. Il faro è attivo dal 1656.' },
  { day: 34, emoji: '⛵', text: 'La costa sud della Norvegia tra Stavanger e Kristiansand è chiamata \'Sørlandet\' (terra del sud) — ha il clima più mite del paese e le spiagge più calde, con acqua che raggiunge i 20°C in estate.' },
  { day: 34, emoji: '🏮', text: 'Under è il primo ristorante sottomarino d\'Europa, vicino a Lindesnes — la struttura affonda 5 metri sotto il livello del mare e ha una vetrata panoramica di 11×4 m sul fondale marino.' },
  { day: 34, emoji: '🏖️', text: 'Kristiansand è la "Riviera norvegese" — ha le temperature estive più alte della Norvegia e spiagge di sabbia bianca dove i norvegesi vanno in vacanza.' },
  { day: 34, emoji: '🦁', text: 'Lo zoo di Kristiansand è il più grande della Norvegia e l\'unico con animali africani — ha anche un parco acquatico e un villaggio di Capitan Sabertooth.' },
  { day: 35, emoji: '🚢', text: 'Il traghetto Kristiansand-Hirtshals attraversa lo Skagerrak in ~2h30 — lo stesso stretto dove nel 1940 affondò l\'incrociatore tedesco Blücher.' },
  { day: 35, emoji: '🌊', text: 'Lo Skagerrak è il punto dove Mare del Nord e Mar Baltico si incontrano — le correnti creano onde particolari visibili dalla nave.' },
  { day: 35, emoji: '🇩🇰', text: 'La Danimarca è composta da 443 isole (di cui 78 abitate) — il paese è così piatto che il punto più alto è solo 170 metri!' },
  { day: 36, emoji: '🎢', text: 'I Giardini di Tivoli a Copenhagen, aperti nel 1843, sono il secondo parco divertimenti più antico del mondo — e ispirarono Walt Disney per Disneyland!' },
  { day: 36, emoji: '🧜‍♀️', text: 'La Sirenetta di Copenhagen è alta solo 1,25 metri — è una delle attrazioni più piccole e più fotografate del mondo (dal 1913).' },
  { day: 36, emoji: '🏰', text: 'Il Castello di Rosenborg a Copenhagen custodisce i gioielli della corona danese — inclusa una corona con 2.500 diamanti e una spada del 1551.' },
  { day: 36, emoji: '🚲', text: 'A Copenhagen ci sono più biciclette che abitanti: 675.000 bici per 630.000 persone. Il 49% dei residenti va al lavoro in bici ogni giorno.' },
  { day: 36, emoji: '🏘️', text: 'Nyhavn, il porto colorato di Copenhagen, fu costruito nel 1671 come porto commerciale — Hans Christian Andersen visse qui ai numeri 18, 20 e 67.' },
  { day: 36, emoji: '♻️', text: 'Copenhagen punta a diventare la prima capitale carbon-neutral del mondo. L\'inceneritore Amager Bakke ha una pista da sci sul tetto!' },
  { day: 36, emoji: '🏗️', text: 'LEGOLAND Billund ha un modello del Monte Rushmore fatto con 1,5 milioni di mattoncini — ci sono voluti 3 anni per costruirlo!' },
  { day: 36, emoji: '🤖', text: 'Il Miniland di LEGOLAND Billund riproduce monumenti di tutto il mondo con 20 milioni di mattoncini — i modelli si muovono, hanno luci e suoni.' },
  { day: 36, emoji: '📏', text: 'Il mattoncino LEGO è prodotto con una tolleranza di 0,002 mm — più preciso di un orologio svizzero. Ecco perché i pezzi del 1958 si incastrano ancora con quelli di oggi.' },
  { day: 37, emoji: '🚗', text: 'Il viaggio da Copenhagen a Billund attraversa la Danimarca da est a ovest — 260 km di pianure, mulini a vento e il Grande Belt, il ponte sospeso più lungo d\'Europa (1.624 m di campata).' },
  { day: 37, emoji: '🏰', text: 'Lungo la strada per Billund si passa vicino a Odense, città natale di Hans Christian Andersen — lo scrittore di fiabe che ha inventato La Sirenetta, Il Brutto Anatroccolo e La Regina delle Nevi.' },
  { day: 37, emoji: '🌬️', text: 'La Danimarca produce il 50% della sua elettricità dall\'eolico — il paese è così piatto che i parchi eolici sono visibili praticamente ovunque durante il viaggio.' },
  { day: 38, emoji: '🧱', text: 'La parola LEGO viene dal danese "leg godt" che significa "gioca bene". L\'azienda fu fondata nel 1932 a Billund da un falegname, Ole Kirk Christiansen.' },
  { day: 38, emoji: '🏭', text: 'La fabbrica LEGO di Billund produce 36 miliardi di mattoncini all\'anno — circa 1.140 pezzi al secondo, 24 ore su 24!' },
  { day: 38, emoji: '🌍', text: 'Billund era un villaggio di 300 abitanti prima della LEGO — oggi è una città di 6.800 persone con il secondo aeroporto più grande della Danimarca.' },
  ...
  { day: 39, emoji: '🧱', text: 'La LEGO House a Billund ha 25 milioni di mattoncini e un albero di 15 metri costruito interamente in LEGO — ci sono voluti 6.316 ore di lavoro per assemblarlo pezzo per pezzo.' },
  { day: 39, emoji: '🏊', text: 'Lalandia è il più grande parco acquatico coperto della Scandinavia — con scivoli, onde artificiali e una temperatura tropicale di 30°C anche in pieno inverno danese.' },
  { day: 39, emoji: '🎨', text: 'Nella LEGO House c\'è una zona dove un robot fotografa la tua faccia e la ricrea in mattoncini LEGO in tempo reale — il ritratto viene poi aggiunto a una galleria permanente di volti.' },
  { day: 40, emoji: '🐴', text: 'I Musicanti di Brema (asino, cane, gatto e gallo) non arrivarono mai a Brema nella fiaba dei Grimm — si fermarono prima! La statua in città è del 1953.' },
  { day: 40, emoji: '🤞', text: 'Toccare le zampe dell\'asino nella statua dei Musicanti di Brema porta fortuna — sono lucide per i milioni di mani che le hanno strofinate!' },
  { day: 40, emoji: '🚀', text: 'Brema è una città-stato (come Berlino e Amburgo) ed è sede dell\'Airbus Defence & Space — qui si costruiscono moduli della Stazione Spaziale Internazionale.' },
  { day: 41, emoji: '⛪', text: 'La cattedrale di Amiens è la più grande cattedrale gotica di Francia per volume (200.000 m³) — ci entrerebbero 2 Notre-Dame di Parigi!' },
  { day: 41, emoji: '💡', text: 'Di notte la cattedrale di Amiens viene illuminata con i colori originali medievali — nel Medioevo le cattedrali erano dipinte a colori vivaci, non grigie!' },
  { day: 41, emoji: '📖', text: 'Jules Verne visse ad Amiens per 34 anni e scrisse qui la maggior parte dei suoi romanzi — la sua casa è ora un museo con 15.000 documenti.' },
  { day: 42, emoji: '🏰', text: 'La Valle della Loira ha oltre 300 castelli in 280 km — più castelli per km² di qualsiasi altra regione al mondo.' },
  { day: 42, emoji: '🏰', text: 'Il Castello di Chambord ha 440 stanze, 365 camini e una scala a doppia elica progettata (forse) da Leonardo da Vinci — due persone salgono senza mai incontrarsi.' },
  { day: 42, emoji: '🌹', text: 'Il Castello di Villandry ha i giardini rinascimentali più belli di Francia — 52.000 piante vengono sostituite due volte l\'anno per mantenere i disegni geometrici.' },
  { day: 43, emoji: '🎨', text: 'Leonardo da Vinci trascorse gli ultimi 3 anni della sua vita al Clos Lucé, invitato da Francesco I. Morì qui nel 1519 — portò con sé la Gioconda dall\'Italia!' },
  { day: 43, emoji: '👸', text: 'Il Castello di Chenonceau è chiamato "il castello delle donne" — fu costruito, ampliato e salvato da 6 donne diverse in 400 anni.' },
  { day: 43, emoji: '🌉', text: 'Chenonceau è l\'unico castello costruito su un fiume — il suo ponte-galleria sul Cher fu usato come via di fuga durante la Seconda Guerra Mondiale.' },
  { day: 44, emoji: '🍽️', text: 'San Sebastián ha la più alta concentrazione di stelle Michelin per metro quadrato al mondo — 19 stelle in una città di 180.000 abitanti.' },
  { day: 44, emoji: '🍢', text: 'I pintxos di San Sebastián non sono tapas — sono mini-capolavori gastronomici serviti su stuzzicadenti. Un giro dei bar del centro è un\'esperienza obbligatoria!' },
  { day: 44, emoji: '🏖️', text: 'La Playa de la Concha di San Sebastián è stata votata la spiaggia urbana più bella d\'Europa — una mezzaluna perfetta nel centro della città.' },
  { day: 45, emoji: '🐕', text: '"Puppy" davanti al Guggenheim di Bilbao è un cane di 12 metri ricoperto da 37.000 piante fiorite — viene ripiantato due volte l\'anno!' },
  { day: 45, emoji: '🏗️', text: 'Il Guggenheim di Bilbao ha trasformato una città industriale in declino in una meta turistica mondiale — l\'"effetto Bilbao" è studiato nelle università.' },
  { day: 45, emoji: '🕷️', text: '"Maman", il ragno gigante di Louise Bourgeois davanti al Guggenheim, è alto 9 metri e pesa 8 tonnellate — sotto la pancia ha 26 uova di marmo.' },
  { day: 46, emoji: '🚡', text: 'La funivia di Fuente Dé sale 753 metri in soli 4 minuti — è una delle più ripide d\'Europa, con una vista a 360° sui Picos de Europa.' },
  { day: 46, emoji: '🐺', text: 'I Picos de Europa ospitano lupi, orsi bruni e avvoltoi — è una delle ultime aree selvagge dell\'Europa occidentale.' },
  { day: 46, emoji: '🧀', text: 'Il formaggio Cabrales dei Picos de Europa viene stagionato in grotte naturali a 1.000m di altitudine — il suo sapore intenso è famoso in tutto il mondo.' },
  ...
  { day: 49, emoji: '💨', text: 'La Tramontana a Cap de Creus può soffiare a 150 km/h — il vento ha scolpito le rocce in forme così strane che Dalí le dipingeva nei suoi quadri.' },
  { day: 49, emoji: '🐙', text: 'La Costa Brava ha una riserva marina protetta a Cap de Creus — con posidonia, cernie giganti e corallo rosso a pochi metri dalla riva.' },
  { day: 50, emoji: '🎨', text: 'Cadaqués fu il rifugio di Dalí per 50 anni. La sua casa-museo a Portlligat ha uova giganti sul tetto e un labirinto di stanze surreali.' },
  { day: 50, emoji: '🎭', text: 'Il Teatro-Museo Dalí a Figueres è il museo più visitato della Spagna dopo il Prado — Dalí è sepolto sotto il palcoscenico, come volle lui.' },
  { day: 50, emoji: '🐟', text: 'Cadaqués era un villaggio di pescatori così isolato (raggiungibile solo via mare) che sviluppò un dialetto catalano unico, ancora parlato oggi.' },
  { day: 51, emoji: '🏎️', text: 'La Costa Azzurra prende il nome dal libro "La Côte d\'Azur" (1887) dello scrittore Stéphen Liégeard — prima si chiamava semplicemente "Riviera".' },
  { day: 51, emoji: '🎬', text: 'Il Festival di Cannes proietta circa 200 film in 12 giorni — ma solo 20 competono per la Palma d\'Oro. Il red carpet è lungo 60 metri.' },
  { day: 51, emoji: '🌿', text: 'Grasse, nell\'entroterra della Costa Azzurra, è la capitale mondiale del profumo — produce il 66% dei profumi francesi da oltre 400 anni.' },
  { day: 52, emoji: '🐬', text: 'L\'Acquario di Genova è il più grande d\'Italia e il secondo in Europa: 70 vasche, 12.000 animali di 600 specie, e una vasca tattile dove toccare le razze!' },
  { day: 52, emoji: '🌐', text: 'L\'Acquario di Genova fu costruito da Renzo Piano per l\'Expo 1992 (500 anni dalla scoperta dell\'America) — la struttura sembra una nave in porto.' },
  { day: 52, emoji: '🦈', text: 'L\'Acquario di Genova ha la più grande vasca di squali del Mediterraneo — con squali martello, mante e una ricostruzione della barriera corallina.' },
  { day: 53, emoji: '⛵', text: 'Genova fu la "Superba" — la repubblica marinara più ricca del Medioevo. Cristoforo Colombo nacque qui nel 1451, e la sua casa è ancora visitabile.' },
  { day: 53, emoji: '🍝', text: 'Il pesto alla genovese ha solo 7 ingredienti (basilico DOP, pinoli, aglio, parmigiano, pecorino, olio, sale) — e il basilico DEVE essere di Prà, un quartiere di Genova.' },
  { day: 53, emoji: '🏘️', text: 'I "caruggi" di Genova formano il centro storico medievale più grande d\'Europa — un labirinto di 5 km² dove il sole non entra mai.' },
  ...
  async (event) => {
    ...
    if (fullTexts.length > 0) {
      try {
        ...
        const summaryPrompt = `Riassumi SOLO il contenuto dei post qui sotto in 2-3 frasi brevi in italiano. REGOLE TASSATIVE: 1) NON aggiungere fatti, numeri, km, luoghi o informazioni che NON sono esplicitamente scritte nei testi. 2) NON inventare nulla. 3) Se un'informazione non è nei post, non menzionarla. 4) Tono informale e caloroso, senza emoji. 5) NON usare riferimenti temporali come "oggi", "ieri", "stamattina", "questa mattina", "stasera", "nel pomeriggio" — descrivi gli eventi in modo neutro senza collocarli nel tempo (i post potrebbero essere stati scritti in ritardo rispetto agli eventi descritti).\n\nPost del giorno:\n${allText.substring(0, 2000)}`;
          ...
          try {
            return await fetch('https://api.openai.com/v1/chat/completions', {
              ...
              body: JSON.stringify({
                model: 'gpt-4o-mini',
                messages: [
                  { role: 'system', content: 'Rispondi SOLO con il riassunto richiesto, niente altro. NON usare mai parole temporali come "oggi", "ieri", "stamattina".' },
