...
var CURIOSITA_DATA = [
  ...
  { day: -25, emoji: "🗺️", text: "Il vostro viaggio coprirà circa 9.900 km — la stessa distanza che separa Roma da Tokyo in linea d'aria!", source: "Calcolo itinerario" },
  ...
  { day: -23, emoji: "☀️", text: "A Tromsø, in Norvegia, il sole non tramonta dal 20 maggio al 22 luglio: 64 giorni consecutivi di luce!", source: "Institute of Marine Research, Norway" },
  ...
  { day: -16, emoji: "🎨", text: "Il Guggenheim di Bilbao è ricoperto da 33.000 lastre di titanio — ognuna spessa meno di mezzo millimetro (0,38 mm).", source: "Guggenheim Bilbao Museum" },
  ...
  // G2 - Leoben → Vienna
  { day: 1, emoji: "🎡", text: "La Riesenrad del Prater di Vienna gira dal 1897 — ha 129 anni ed è una delle ruote panoramiche più antiche del mondo ancora in funzione.", source: "Wiener Riesenrad" },
  { day: 1, emoji: "🎵", text: "Vienna ha più compositori famosi sepolti di qualsiasi altra città: Beethoven, Schubert, Strauss, Brahms — tutti nello stesso cimitero (Zentralfriedhof), dove anche Mozart ha un monumento commemorativo.", source: "Wien Tourismus" },
  ...
  { day: 8, emoji: "🦭", text: "Nel lago Saimaa vive la foca degli anelli più rara del mondo: ne restano solo ~480 esemplari, intrappolati qui dalla fine dell'era glaciale.", source: "WWF Finland" },
  ...
  { day: 15, emoji: "🍺", text: "Tromsø ha lo storico birrificio Mack (fondato nel 1877), uno dei più settentrionali del mondo, e la più alta concentrazione di pub pro capite della Norvegia.", source: "Mack Bryggeri" },
  ...
  { day: 28, emoji: "🌊", text: "La cascata Stigfossen sulla Trollstigen cade per 240 metri — l'acqua nebulizzata bagna le auto che passano sotto. Chiudete i finestrini!", source: "Norwegian Public Roads Administration" },
