...
const CACHE_NAME = 'quo-vadis-v5.16';
...
const STATIC_ASSETS = [
  ...
  './capacitor-gps-bridge.js?v=5.16',
  './offline.html',
  './home-variants.html',
  './home-variants_en.html',
  './home-variants_es.html',
  './home-variants.css',
  './home-variants.js?v=5.16',
  './unified-map.js?v=5.16',
  './unified-map.css',
  './poi-data.js?v=5.16',
  './modern-pages.css',
  './curiosita-data.js?v=5.16',
  './curiosita-scheduler.js?v=5.16',
  './quiz-fun.js?v=5.16',
  './city-itineraries.js?v=5.16',
  './city-itineraries-ui.js?v=5.16',
