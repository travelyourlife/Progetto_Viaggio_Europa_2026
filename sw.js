...
const CACHE_NAME = 'quo-vadis-v5.49';
...
const STATIC_ASSETS = [
  ...
  './capacitor-gps-bridge.js?v=5.49',
  './offline.html',
  './home-variants.html',
  './home-variants_en.html',
  './home-variants_es.html',
  './home-variants.css',
  './home-variants.js?v=5.49',
  './unified-map.js?v=5.49',
  './unified-map.css',
  './poi-data.js?v=5.49',
  './modern-pages.css',
  './curiosita-data.js?v=5.49',
  './curiosita-scheduler.js?v=5.49',
  './quiz-fun.js?v=5.49',
  // city-itineraries.js: NOT precached (v5.25) — lazy-loaded on first open of Itinerari città tab
  './city-itineraries-ui.js?v=5.49',
