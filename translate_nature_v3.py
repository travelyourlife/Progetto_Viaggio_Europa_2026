#!/usr/bin/env python3
"""Translate the expanded Finland nature encyclopedic content from IT to EN and ES."""
import os
...
def translate_file(input_path, output_path, target_lang, lang_name):
    ...
    # Split into chunks at ## headers to avoid token limits
...
- Keep Finnish names (*mänty*, *kuusi* etc.) unchanged  
- Keep image paths unchanged (e.g. images/nature/scots-pine.jpg)
...
- Do NOT translate the table header row formatting (|:---|:---|:---|)"""},
...
input_file = '/home/ubuntu/quo-vadis/finland-nature-encyclopedic-it.md'

print("=== Translating to English ===")
translate_file(input_file, '/home/ubuntu/quo-vadis/finland-nature-encyclopedic-en.md', 'English', 'English')

print("\n=== Translating to Spanish ===")
translate_file(input_file, '/home/ubuntu/quo-vadis/finland-nature-encyclopedic-es.md', 'Spanish', 'Spanish')
